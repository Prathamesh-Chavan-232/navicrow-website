export const Hero = () => {
	return (
		<div className="w-screen h-screen">
			<div className="px-10 lg:px-60 py-60 flex flex-col items-center justify-center">
				<div className="pb-8 text-xl text-center">
					Connecting your journey with purpose
				</div>
				<h1 className="text-5xl font-fancy text-center xl:px-72 lg:text-7xl lg:text-center">
